...
class DockerImageAnalyzer:
    ...
    def format_yaml_output(self, config: dict) -> str:
        ...
        lines.append("# Generated by generate_stages.py, do not edit by hand")
        lines.append("# Run 'make stages' to regenerate this file")
        lines.append("")
    ...
    def generate_comprehensive_analysis(self) -> str:
        ...
        report = []
        report.append("<!-- Generated by generate_stages.py, do not edit by hand -->")
        report.append("<!-- Run 'make analysis' to regenerate this file -->")
        report.append("")
...
\t@date -Idate > date.txt
\t@trap 'rm -f date.txt' EXIT; docker build --platform linux/amd64 -t {full_image_name}:latest-amd64 .
...
\t@echo "Creating date file for cache invalidation..."
\t@date -Idate > date.txt
\t@trap 'rm -f date.txt' EXIT; docker build --platform linux/arm64 -t {full_image_name}:latest-arm64 .
